...
# Per-branch copy for the IMAGE track (provenance: research/privacy_dl_ts/p4_ddg.py).
# Pure integer-math module (only dp.py imported at call time); mirror any sampler or
# pmf-check fix across both copies per the agreed per-branch topology.

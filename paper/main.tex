...
\input{sections/09-side-channels}
\input{sections/10-does-it-work}
\input{sections/11-model-choice}
\input{sections/12-anonymisation-test}
\input{sections/13-real-data}
\input{sections/14-outside-scope}
\input{sections/15-recommendations}

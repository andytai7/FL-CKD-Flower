...
%% Build: pdfLaTeX + biber.  Overleaf: upload this directory, compiler pdfLaTeX.
...
\vspace{18pt}
{\large\bfseries Prepared by:} the FLIP-IT technical work package.
...
\input{sections/02-payload}
\input{sections/03-isolation}
\input{sections/04-flowerlabs}
\input{sections/05-secagg}
\input{sections/06-noise-placement}
\input{sections/07-budget}
\input{sections/08-reducing-epsilon}
\input{sections/09-aggregate-disclosure}
\input{sections/10-side-channels}
\input{sections/11-does-it-work}
\input{sections/12-model-choice}
\input{sections/13-anonymisation-test}
\input{sections/14-real-data}
\input{sections/15-outside-scope}
\input{sections/16-recommendations}

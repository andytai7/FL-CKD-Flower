...
\textbf{It is a configuration state, not an architectural limit.} Federated learning does not
...
analytics path unchanged. \S\ref{sec:aggdisclosure} develops what \emph{does} genuinely differ.

...
\begin{tabular}{p{6.6cm}p{6.6cm}}
  ...
  \addlinespace
  Central DP does not change what the server receives; only noise added inside the practice does
  record-level DP-SGD is the deployed form (\S\ref{sec:noise})
  ...
  (\S\ref{sec:payload})
  & The utility cost of record-level DP-SGD at the pilot's scale \\
  \addlinespace
